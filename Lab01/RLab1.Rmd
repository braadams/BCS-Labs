...
for (i in CBdata.1_10){
 CBdata.1_10df <- rbind(CBdata.1_10df,i)
}

CBdata.1_10_clean <- CBdata.1_10df[-6]
CBdata.1_10_clean <- filter.func(CBdata.1_10_clean)



dat.76.clean4 <- CBdata.1_10_clean[CBdata.1_10_clean$Year==1976,] 

rownames(dat.76.clean) <- NULL
...
firstfive <- CBdata.1_10_clean[CBdata.1_10_clean$Year%in%1973:1977,]

mean(firstfive$Age)

secondfive <- CBdata.1_10_clean[CBdata.1_10_clean$Year%in%1978:1982,]
mean(secondfive$Age)
